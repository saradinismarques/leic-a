...
#include <cdk/ast/visitor_decls.h>
  ...
  virtual void do_addressof_node(fir::addressof_node *const node, int lvl) = 0;
  ...
  virtual void do_func_call_node(fir::func_call_node *const node, int lvl) = 0;
  virtual void do_func_decl_node(fir::func_decl_node *const node, int lvl) = 0;
  virtual void do_func_def_node(fir::func_def_node *const node, int lvl) = 0;
  ...
  virtual void do_pos_node(fir::pos_node *const node, int lvl) = 0;
  ...
  virtual void do_var_decl_node(fir::var_decl_node *const node, int lvl) = 0;
  virtual void do_while_node(fir::while_node *const node, int lvl) = 0;

#else
  void do_addressof_node(fir::addressof_node *const node, int lvl);
  ...
  void do_func_call_node(fir::func_call_node *const node, int lvl);
  void do_func_decl_node(fir::func_decl_node *const node, int lvl);
  void do_func_def_node(fir::func_def_node *const node, int lvl);
  ...
  void do_pos_node(fir::pos_node *const node, int lvl);
  ...
  void do_var_decl_node(fir::var_decl_node *const node, int lvl);
