...
void fir::frame_size_calculator::do_addressof_node(fir::addressof_node *const node, int lvl) {
    // EMPTY
}

void fir::frame_size_calculator::do_func_call_node(fir::func_call_node *const node, int lvl) {
    // EMPTY
}
...
void fir::frame_size_calculator::do_var_decl_node(fir::var_decl_node *const node, int lvl) {
    _localsize += node->type()->size();
}

void fir::frame_size_calculator::do_func_def_node(fir::func_def_node *const node, int lvl) {
    node->body()->accept(this, lvl + 2);
}

void fir::frame_size_calculator::do_func_decl_node(fir::func_decl_node *const node, int lvl) {
    _localsize += node->type()->size();
}
...
void fir::frame_size_calculator::do_pos_node(fir::pos_node *const node, int lvl) {
    // EMPTY
}
