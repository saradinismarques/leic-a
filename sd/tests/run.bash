...
# 03-student
mvn -q compile exec:java -Dexec.args="aluno1001 Manuel Goucha" <../tests/input/03-student.in >../tests/output/03-student.out 2>/dev/null
...
# 04-professor
cd ../Professor || exit
mvn -q compile exec:java <../tests/input/04-professor.in >../tests/output/04-professor.out 2>/dev/null
...
# 05-student
cd ../Student || exit
mvn -q compile exec:java -Dexec.args="aluno1001 Manuel Goucha" <../tests/input/05-student.in >../tests/output/05-student.out 2>/dev/null
...
# 06-professor
cd ../Professor || exit
mvn -q compile exec:java <../tests/input/06-professor.in >../tests/output/06-professor.out 2>/dev/null
...
# 07-student
cd ../Student || exit
mvn -q compile exec:java -Dexec.args="aluno1000 Cristina Ferreira" <../tests/input/07-student.in >../tests/output/07-student.out 2>/dev/null
