...
public enum ErrorMessage {
    ...
    SAME_QUESTION_FAILED_ANSWER_ALREADY_ADDED("Failed Answer already added to same question"),
    ...
    DIFFICULT_QUESTION_ALREADY_ADDED("Cannot add duplicate difficult question to same difficulty set");
