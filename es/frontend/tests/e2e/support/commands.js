...
//SOLVE QUIZZ DIFFICULT QUESTION
Cypress.Commands.add('solveQuizDifficultQuestions', (quizTitle, numberOfQuizQuestions) => {
  cy.get('[data-cy="quizzesStudentMenuButton"]').click();
  cy.contains('Available').click();
...
//UPDATE DIFFICULT QUESTION
Cypress.Commands.add('updateDifficultQuestions', () => {
  ...
  cy.get('[data-cy="showStudentViewDialogButton"]').eq(0).click({ force: true });
  cy.get('[data-cy="closeButton"]').click();

  cy.route('DELETE', '/difficultQuestions/*').as('deleteDifficultQuestion');
  cy.get('[data-cy="deleteDifficultQuestionButton"]').eq(0).click();
  cy.wait('@deleteDifficultQuestion');
  cy.get('[data-cy="deleteDifficultQuestionButton"]').eq(1).click();
  cy.wait('@deleteDifficultQuestion');
});
...
Cypress.Commands.add('solveToFailQuizz', (quizTitle, numberOfQuizQuestions) => {
    cy.get('[data-cy="quizzesStudentMenuButton"]').click();
    cy.contains('Available').click();
