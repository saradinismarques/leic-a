...
class RicochetRobots(Problem):
    ...
    def h(self, node: Node):
        ...
        if node.action:
            ...
            target_robot = node.state.board.target[0]
            robot = node.action[0]
            robot_pos = board_after_action.robot_position(robot)
            ...
            if robot == target_robot:
                ...
                pos = board_after_action.robot_position(target_robot)
                if robot_pos[0] == target_pos[0] or robot_pos[1] == target_pos[1]:
                    if pos[0] == target_pos[0] or pos[1] == target_pos[1]:
                        return 2
                    else:
                        return 3
                else:
